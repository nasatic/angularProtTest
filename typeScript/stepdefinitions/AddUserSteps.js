...
var AddUserPage_1 = require("../pages/AddUserPage");
...
cucumber_1.When(/^I enter username '(.*?)' and password '(.*?)'$/, function (uname, pass) { return __awaiter(_this, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                _a.sent();
                return [4 /*yield*/, login.enterUserName(uname)];
            case 2:
                _a.sent();
                return [4 /*yield*/, login.delayBrowser(2)];
            case 3:
                _a.sent();
                return [4 /*yield*/, login.enterPassword(pass)];
            case 4:
                _a.sent();
